...
// Generated from the top ~2000 teams by 24h PPD, 2026-08-15. Names and every
...
// groups, and language groups like Alliance Francophone.
var countryDefs = []countryDef{
	{Code: "US", Name: "United States", TeamIDs: []int32{
		...
		258971, 258507, 1239, 251259, 253428, 266931, 154420, 96, 883, 165492, 215762, 258837,
		241205, 270, 234080, 48083, 238444, 238889, 150682, 244353, 233664, 242687, 134751,
		138884, 31659, 233097, 60194, 95796, 249802, 258415, 35933, 171808, 682, 237210, 258192,
		254839, 34485, 257967, 237390, 238120, 234192, 249845, 166540, 243788, 242893, 153879,
		254378, 49191, 241561, 3083, 248357, 258823, 2740, 96207, 2075, 245750, 234456, 12233,
		2116, 251951, 749, 51431, 229192, 240498, 249513, 173573, 238779, 257885, 254273, 1305,
		241525, 237854, 38296, 41235, 264662, 243025, 261194, 245613, 256630, 58812, 245804,
		1064857, 241960, 1065005, 46301, 256579, 159533, 139472, 244109, 47816, 231032, 252373,
		251447, 252534, 258145, 12477, 225826, 1065661, 1064178, 1064163, 1064804, 1066375,
		229657, 239702, 268686, 222470, 1809, 237714, 255950, 51524, 232820, 10213, 235547,
		246058, 267870, 267181, 229346, 257105, 1065796, 245607, 1060772, 55309, 252647, 214786,
		244326, 248794, 251060, 2032, 160705, 10175, 239639, 256429, 252716, 249321, 172248,
		242558, 31673, 238420, 2334, 46680, 238422, 134469, 249282, 199966, 257290, 3148, 199679,
		42753, 33308, 240012, 233087, 3361, 68421, 243097, 61404, 59002, 233316, 1065087, 259844,
		1572, 48157, 35554, 1062578, 249630, 1066032, 250265, 1065152, 1063948, 1066405, 56606,
		1062811, 1, 1003, 10033, 10276, 1061333, 1062094, 1062270, 1063131, 1063984, 1064729,
		1064918, 1065368, 1066016, 1066028, 1066076, 1066120, 1066792, 1066882, 1067245, 1067634,
		1068131, 10971, 111065, 11108, 11142, 112, 11232, 11314, 11534, 116608, 11681, 12072,
		1287, 13051, 13180, 134653, 13515, 13622, 13761, 14, 148892, 15, 163348, 163473, 168145,
		1701, 171061, 1739, 180172, 1805, 198, 1991, 204860, 209894, 213698, 2233, 224746,
		227286, 227455, 227867, 229258, 231250, 231300, 232084, 234523, 234771, 235, 235955,
		236284, 236370, 236584, 236709, 236760, 237882, 239945, 240045, 240755, 243108, 243112,
		243210, 243214, 243253, 243801, 245058, 245755, 245860, 246129, 247019, 247217, 248140,
		249559, 249560, 249708, 250186, 250299, 251626, 252071, 252180, 253811, 256378, 256729,
		257104, 257196, 257944, 257991, 259414, 259665, 259918, 260722, 261829, 261972, 262556,
		263476, 264460, 2653, 2654, 267635, 3007, 3074, 3103, 31658, 32, 32035, 3212, 32407, 33,
		33147, 33258, 3357, 33577, 34149, 3430, 3446, 34479, 34687, 35054, 35126, 36120, 37726,
		37742, 38228, 38928, 39227, 39797, 4, 40051, 40098, 40211, 40247, 40965, 41167, 42028,
		43573, 44352, 446, 44851, 45435, 50511, 50906, 50945, 50959, 50979, 52552, 52737, 54238,
		55236, 55260, 57391, 59, 59515, 604, 64534, 68208, 69710, 711, 716, 717, 734, 74413,
		77397, 86926, 88682, 93, 999,
	}},
	{Code: "DE", Name: "Germany", TeamIDs: []int32{
		...
		229160, 237775, 262941, 250888, 165208, 1065107, 10022, 1065430, 1067091, 1067373,
		1068028, 226201, 229957, 229984, 235850, 235935, 239199, 240251, 240286, 240890, 241412,
		242601, 243047, 243871, 246632, 250660, 251999, 252034, 253305, 256656, 257831, 263429,
		264169, 264821, 265346, 265898, 266722, 267356, 3, 34361, 43829, 45456, 45700, 45876,
		53140, 70335, 70408, 70911,
	}},
	{Code: "NO", Name: "Norway", TeamIDs: []int32{
		241978, 1064929, 254030, 237803, 61994, 1065660, 183891, 237481, 237638, 240650, 243541,
		264955, 37651, 37827,
	}},
	{Code: "RU", Name: "Russia", TeamIDs: []int32{
		247472, 228792, 122296, 279, 47191,
	}},
	{Code: "GB", Name: "United Kingdom", TeamIDs: []int32{
		...
		163049, 1064077, 1068232, 1068331, 234111, 242995, 243272, 244604, 244613, 245403,
		250966, 251803, 252914, 258322, 263289, 35947, 37363, 46590, 54234, 588, 61671, 69263,
		98860,
	}},
	...
	{Code: "AU", Name: "Australia", TeamIDs: []int32{
		253919, 252720, 267219, 36010, 237022, 244539, 186, 225000, 24, 243288, 246095, 266266,
		267244, 267810, 43781, 44171, 46401, 47155,
	}},
	{Code: "TW", Name: "Taiwan", TeamIDs: []int32{
		244178, 37766, 46810, 31403,
	}},
	...
	{Code: "CA", Name: "Canada", TeamIDs: []int32{
		...
		47936, 86, 253168, 246505, 247736, 256609, 190589, 34384, 264085, 127980, 1064775,
		1068265, 10733, 10987, 253800, 256648, 31574, 34242, 37412, 54196, 60,
	}},
	{Code: "SE", Name: "Sweden", TeamIDs: []int32{
		1061755, 252390, 242624, 256133, 256869, 241128, 42956, 241438, 246962, 239904, 1068136,
		239347, 245476, 247646, 260500, 37451, 74600, 831,
	}},
	{Code: "NZ", Name: "New Zealand", TeamIDs: []int32{
		11053, 246916, 32887,
	}},
	{Code: "NL", Name: "Netherlands", TeamIDs: []int32{
		247522, 236111, 242482, 1067515, 1288, 13505, 48658, 69411, 92,
	}},
	{Code: "JP", Name: "Japan", TeamIDs: []int32{
		261481, 260900, 253284, 259660, 60630, 264997, 256823, 106346, 259877, 55486, 39204,
		254224, 264491, 260045, 257002, 256822, 242102, 263798, 256025, 254156, 255463, 259015,
		261543, 263995, 1064945, 1067225, 162, 179680, 222, 253230, 254140, 254402, 255396,
		257261, 257728, 258804, 261092, 264379,
	}},
	{Code: "FR", Name: "France", TeamIDs: []int32{
		229738, 44798, 261556, 263483, 243764, 420, 263700, 244682, 1065443, 10317, 200905,
		236445, 242460, 247377, 251916, 45363,
	}},
	...
	{Code: "PL", Name: "Poland", TeamIDs: []int32{
		254123, 250728, 1064915, 1066850, 276, 77920,
	}},
	...
	{Code: "FI", Name: "Finland", TeamIDs: []int32{
		237157, 257637, 240198, 242321, 235445, 245556, 365, 231988, 239618, 250694, 254869,
		38850, 454, 62,
	}},
	{Code: "HU", Name: "Hungary", TeamIDs: []int32{
		240228, 239968, 43299, 679,
	}},
	{Code: "GR", Name: "Greece", TeamIDs: []int32{
		1065818, 1068194, 13416, 3322, 36673, 44079, 838,
	}},
	{Code: "CZ", Name: "Czechia", TeamIDs: []int32{
		252064, 249477, 237170, 245800, 241054, 246927, 263313, 241584, 261291, 114, 1067491,
		157986, 235910, 236157, 236542, 236798, 240727, 246110, 49658,
	}},
	{Code: "IT", Name: "Italy", TeamIDs: []int32{
		1065, 246223, 262479, 249208, 263392, 69630, 180924, 246330, 252841, 256411, 61171,
	}},
	...
	{Code: "BE", Name: "Belgium", TeamIDs: []int32{
		37249, 243566, 34517, 233874, 33528, 243169, 240743, 239672, 3455, 37639,
	}},
